...
public class VueTas {
    ...
    public void afficher(Graphics2D g2D) {
        Tas tas = this.vuePuits.getPuits().getTas();
        int taille = this.vuePuits.getTaille();

        if (tas != null) {
            // It seems getElements() returns an array in some versions of the student code
            // and a List in others. Iterating this way works for both.
