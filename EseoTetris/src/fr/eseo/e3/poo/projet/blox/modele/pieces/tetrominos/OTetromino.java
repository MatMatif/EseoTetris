...
public class OTetromino extends Tetromino {
    ...
    /**
     * Un OTetromino ne peut pas tourner. Cette méthode est redéfinie pour être vide.
     * @param sensHoraire Le sens de rotation (ignoré).
     */
    @Override
    public void tourner(boolean sensHoraire) {
        // Ne fait rien, un OTetromino ne tourne pas.
    }
}
