...
public class UsineDePiece {
    ...
    public static Tetromino genererTetromino() {
        ...
        return switch (type) {
            case 0 -> new OTetromino(coords, couleur);
            case 1 -> new ITetromino(coords, couleur);
            case 2 -> new TTetromino(coords, couleur);
            case 3 -> new LTetromino(coords, couleur);
            case 4 -> new JTetromino(coords, couleur);
            case 5 -> new ZTetromino(coords, couleur);
            case 6 -> new STetromino(coords, couleur);
            default -> null;
        };
    }
    ...
    private static Couleur getCouleurParDefaut(int type) {
        return switch (type) {
            case 0 -> Couleur.ROUGE;    // OTetromino
            case 1 -> Couleur.ORANGE;   // ITetromino
            case 2 -> Couleur.BLEU;     // TTetromino
            case 3 -> Couleur.VERT;     // LTetromino
            case 4 -> Couleur.JAUNE;    // JTetromino
            case 5 -> Couleur.CYAN;     // ZTetromino
            case 6 -> Couleur.VIOLET;   // STetromino
            default -> null;
        };
    }
}
